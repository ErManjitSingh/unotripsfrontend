...
export const metadata = {
  title: { absolute: "Thank you | Uno Trips Leh Ladakh" },
  robots: { index: false, follow: false },
};

export default function LehThankYouPage() {
  const ads = LEH_ADS;
  ...
  return (
    <div className="hs1-ty-root">
      ...
      <div className="hs1-ty-card">
        ...
        <p>
          Our Leh Ladakh expert will call you shortly. For faster help, call or WhatsApp now.
        </p>
