            ...
            <form id="cab-booking-form" noValidate onFocus={() => trackOnce("cab_trip_form_started", "cab_trip_form_started", { ride_type: rideType })} onSubmit={submit} className="relative flex w-full flex-col rounded-3xl border border-[#eee3dc] bg-white p-4 shadow-[0_22px_55px_-28px_rgba(71,38,16,0.45)] sm:p-6 lg:p-8">
              ...
              {scheduleMode === "schedule" && <section aria-label="Schedule your pickup" className="order-6 mt-2 rounded-xl border border-orange-100 bg-orange-50/40 p-2.5">
                <div className="grid gap-2 sm:grid-cols-[auto_1fr_1fr] sm:items-end">
                  ...
                  <div><label htmlFor="cab-time" className="mb-1 block text-xs font-bold text-[#514953]">Time <span className="text-[#ef6614]">*</span></label><div className="relative"><Clock3 className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#ef6614]" /><input id="cab-time" type="time" value={travelTime} onChange={(event) => { setTravelTime(event.target.value); setSubmitted(false); }} className="h-10 w-full rounded-lg border border-[#ddd5d1] bg-white pl-9 pr-3 text-sm font-semibold text-[#403842] outline-none focus:border-[#ef6614] focus:ring-4 focus:ring-orange-100" /></div></div>
                </div>
              </section>}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="h-10 w-full rounded-lg border border-[#ddd5d1] bg-white pl-9 pr-3 text-sm font-semibold text-[#403842] outline-none focus:border-[#ef6614] focus:ring-4 focus:ring-orange-100"
                        />
                      </div>
                    </div>
                  </div>
