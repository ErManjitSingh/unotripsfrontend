...
const WA = `https://wa.me/${ADS.whatsapp}?text=${encodeURIComponent(
  "Hi, I want a Himachal tour quote from Himachal Special 1 Ads Landing.",
)}`;
...
function LeadForm({
  ...
  function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      captureType: "form",
      message: "Google Ads Himachal Special 1 landing enquiry",
    };
...
export function HimachalSpecial1Landing({ h1 }: Props) {
