...
if (isset($_POST['submit'])) {
  ...
  $destination = isset($_POST['destinationy']) ? trim($_POST['destinationy']) : 'Kerala';
  ...
  $crmResult = uno_crm_push_lead([
    ...
    'phone' => $mobile,
    'email' => $email,
    'destination' => $destination !== '' ? $destination : 'Kerala',
    'city' => $city,
    'source' => 'Kerala Landing Page',
    'sourceLabel' => 'Kerala Landing Page',
  ...
  try {
    ...
    error_log('[kerala form] mail failed: ' . $e->getMessage());
  }
