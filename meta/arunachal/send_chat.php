...
$plainBody = "Chatbot conversation – Arunachal Pradesh Tour\n\n";
if ($userPhone) {
...
$plainBody .= "\n--- Sent from Arunachal Pradesh Tour chatbot (Uno Trips)";
...
// Header
$htmlBody .= '<tr><td style="background:#075e54; color:#fff; padding:16px 24px; font-size:18px; font-weight:bold;">Arunachal Pradesh Tour – Chatbot Lead</td></tr>';
...
$htmlBody .= '</td></tr>';
$htmlBody .= '<tr><td style="padding:12px 24px; font-size:11px; color:#94a3b8; border-top:1px solid #e5e7eb;">Sent from Arunachal Pradesh Tour chatbot (Uno Trips)</td></tr>';
...
try {
  ...
  $mail->SMTPSecure = 'tls';
  $mail->Port = 587;
  $mail->setFrom('query@ptwhotels.com', 'Uno Trips Chatbot');
  $mail->isHTML(true);
  $mail->CharSet = 'UTF-8';

  $mail->addAddress('unotripsit@gmail.com');
  $mail->addAddress('manjitsingh012345@gmail.com');
  $mail->Subject = 'Chatbot conversation - Arunachal Pradesh Tour';
  $mail->Body = $htmlBody;
