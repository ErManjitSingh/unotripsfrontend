...
$destination = trim((string) ($input['destination'] ?? $input['destinationy'] ?? 'Himachal'));
...
$plainBody = "Chatbot conversation – Himachal Tour\n\n";
if ($userPhone) {
...
$plainBody .= "\n--- Sent from Himachal Tour chatbot (Uno Trips)";
...
// Header
$htmlBody .= '<tr><td style="background:#075e54; color:#fff; padding:16px 24px; font-size:18px; font-weight:bold;">Himachal Tour – Chatbot Lead</td></tr>';
...
try {
  ...
  $mail->Subject = 'Chatbot conversation - Himachal Tour';
  $mail->Body = $htmlBody;
