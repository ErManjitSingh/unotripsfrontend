/**
 * Himachal Pradesh Tour Chatbot - 3 steps only.
...
(function () {
  ...
  var questions = [
    { id: 'dest', text: 'Which Himachal trip are you looking for?', options: ['Manali', 'Shimla', 'Spiti', 'Dharamshala', 'Suggest best package'] },
